...
class HDFreaksEventTime(Poll, Converter, object):
	STARTTIME = 0
	ENDTIME = 1
	REMAINING = 2
	PROGRESS = 3
	...
	def __init__(self, type):
		...
		if type == "EndTime":
			...
			raise ElementError("'%s' is not <StartTime|EndTime|Remaining|Duration|Progress|Runtime> for fenriZerotTime converter" % type)
